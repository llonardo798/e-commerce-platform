package com.linktic.prueba.tecnica.product_catalog_service.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf().disable()
                .authorizeRequests()
                .requestMatchers("/api/product/active").permitAll() // Permite acceso público a /mi-servicio-publico/**
